...
# ╔═╡ b12d43cc-c8e5-11ed-15a1-0f36ab119b72
using PlutoUI

# ╔═╡ ff03dcc9-f99a-43c7-8b08-c1bd1266299a
using Plots

# ╔═╡ bbd21b89-3b78-4e0c-9c03-497379c41bfc
using Symbolics

# ╔═╡ 8c710214-4d65-46ad-be02-fa81c1d1dbfc
using LinearAlgebra

# ╔═╡ d6e8dbcf-25da-4f24-bbd8-c55d8451fa2b
md"""esto es un texto $\alpha+\beta$"""

# ╔═╡ 92f1ac01-f179-4a1b-8381-e8ead2093948
md"""# Prerrequisitos.
Usamos la siguiente librería."""

# ╔═╡ 58075ffc-b058-495b-a500-471d0fcd8ad6
α=2

# ╔═╡ 4ac54146-8c5f-4090-8858-ea4402bd7be6
👎=-1

# ╔═╡ cc4a7140-7876-4201-9196-9ed29842574a
🐱=4

# ╔═╡ 0caab03b-dcfa-43fc-92c6-a87a38f887c6
md"""# Caracteres """

# ╔═╡ c21be198-3705-4c2d-93a5-4f7fbb2196c8
codepoint('a')

# ╔═╡ 17dc6248-e285-49c4-82f6-83415da4602f
md"""# Enteros 
...
# ╔═╡ 3da080e9-0bc5-4ed2-9a94-c33345669e7e
@bind n Slider(-50:50, show_value=true,default=0)

# ╔═╡ e381de2d-0d24-4448-9fa7-d60a863d5a26
typeof(n)

# ╔═╡ 95353f61-97a1-4f5d-a1a8-5c2784000030
bitstring(n)

# ╔═╡ f4c4acc2-6086-4019-8b90-62b46a7d6a8f
1+2+4+8+16+32+64-128

# ╔═╡ b64629bc-4191-4937-8608-2c212f4dc8c9
@bind mint TextField(10, default="0")

# ╔═╡ 273193c7-4d94-4bba-9628-2fa752200677
n8=parse(Int8,mint); bitstring(n8)

# ╔═╡ 64c5230a-698f-483d-a015-e11ad7a585e1
un8=parse(UInt8,mint); bitstring(un8)

# ╔═╡ 99c5bcf3-d2b5-4788-9a12-b17de036fd60
m16=parse(Int16,mint); bitstring(m16)

# ╔═╡ 1b784461-2db6-451f-b275-317ba3cf2dd1
...
# ╔═╡ 96c312f8-9659-4c5c-9ca9-5996455ed56e
k=Int8(127); l=Int8(3)

# ╔═╡ 0ee68e62-e72c-4e66-8971-5f86e16411ff
kplus=k+l

# ╔═╡ 5a68ef60-1c54-4834-8537-5aaeae80121f
md"""Observe también el siguiente ejemplo.
"""

# ╔═╡ eb466f99-d5b6-4752-8da8-02103d959d12
nb=10^100

# ╔═╡ c5a38989-942f-46e3-a0bd-3963ca7f369c
md"""En Julia podemos ver explícitamente los límites para cada una de las representaciones."""

# ╔═╡ c8141802-64e4-4f9b-91ae-2cc8434df646
for T in [Int8,Int16,Int32,Int64,Int128,UInt8,UInt16,UInt32,UInt64,UInt128]
           println("$(lpad(T,7)): [$(typemin(T)),$(typemax(T))]")
end

# ╔═╡ 36115bbb-3456-4ad4-8c93-46332f726d04
md""" 
# Punto Flotante
...
# ╔═╡ 7b59d02a-6c92-4235-b215-2d4de02dd878
md"""
Por ejemplo para $x=0.5$ tenemos en el formato Float32  tenemos bit par el signo 
...
# ╔═╡ 9913ef3d-b3fa-4f35-aa48-62e6a93f5d4d
bitstring(Float32(2.5))

# ╔═╡ a4329cd0-0106-4e60-8ba7-250a7613e86f
begin
	bs=bitstring(Float32(3.5));
	println("signo=",bs[1],"\t exp=",bs[2:9],"\t significand=",bs[19:32])	     
end

# ╔═╡ e85f6b8f-06f8-4393-81a5-3fd080e9d7ed
md""" Otros formatos disponibles son los siguientes."""

# ╔═╡ 365c8cbd-e32a-4b3f-8ccd-b6cd2b2af3c5
begin
	x16=Float16(0.1)
...
# ╔═╡ 000e1843-f4fa-4b32-8053-9db51023871b
begin
	z16=Float16(0.1)
...
# ╔═╡ c7c9559e-bc6b-4491-9ab6-f018aed7fe23
begin
	y16=Float16(π)
	println("x16=\t",y16)
	y32=Float32(π)
...
# ╔═╡ ec7ed0f6-4c0b-4ad1-ad3a-9eae1750f4e6
...
# ╔═╡ 0598a1c3-058b-4a6c-8b1f-52e798658700
(0.1+0.1)==0.2

# ╔═╡ 2f19e70e-6634-4065-8b44-40899a51641e
(0.1+0.1+0.1)==0.3

# ╔═╡ f25836e4-5188-4d69-8b3e-4fc828420694
tol=1E-10; ((0.1+0.1+0.1)-0.3)< tol

# ╔═╡ ca7efe79-4ee2-4c20-8b92-b27051633e4c
(0.1+0.1+0.1)≈0.3 

# ╔═╡ 8c1f16b6-49d8-4f51-ba50-4aad09d91f0e
md"""Veamos que pasa si intentamos sumar x=1/10 varias veces, esto es, 
$\sum_{i=1}^N 0.1$. Veamos la siguiente implementación. """

# ╔═╡ 86c00b4b-1f14-4b85-be67-2fc1d455066c
begin
...
# ╔═╡ 864fa363-fa59-4eda-9542-afc0d9204360
begin
	suma32=Float32(0.0)
	for i=1:N
...
# ╔═╡ 32768777-9bc1-4051-917e-7cc0361d534d
begin
	xx=3E-324
	yy=2E-324
...
# ╔═╡ 66d6223d-dfba-43c3-9fc5-50e50206a087
md""" Ahora numéros positivos grandes. """

# ╔═╡ 8d67eee9-2c99-4202-a8e3-9d279edcd07f
begin
	xp=1.7E+308
...
# ╔═╡ 539cc4bd-4f93-451d-9f7b-174990333abe
begin
xr=1E+26-1E+26+1
yr=1E+26+1-1E+26
...
# ╔═╡ 35302ea5-c58e-4f02-ad81-71fc458f2a2c
begin
	a=1E+308
	b=1.1E+308
	c=-1.001E+308
...
# ╔═╡ 4b0b3447-b463-4caf-a37c-1398fdd3832a
begin
	asq=1E+200
	bsq=1
	ysqr=sqrt( asq^2+bsq^2)
	print(ysqr)
end

# ╔═╡ ae90abca-25dc-461d-98ff-d37023a5b9c9
z=asq*sqrt( 1+(bsq/asq)^2)

# ╔═╡ 890ad63e-e7ab-496b-a0e8-27c2048c6080
begin
...
# ╔═╡ 51a49fd0-9b8f-45a2-9cda-db89040fa466
begin
	xd=1E-15
	yd=((1+xd)-1)/xd
	print("y=",yd)
...
# ╔═╡ 929f71a4-2174-4f0d-95a4-600f1e6ae73e
begin
	aleft=1-12E-3
	aright=1+12E-3
...
# ╔═╡ 1598227d-fc4b-437f-9652-6b0e208780fe
md"""
# Cálculo simbólico
...
# ╔═╡ cf0748b7-50f4-4bfe-a68f-4c4b3e179cec
@variables s t

# ╔═╡ 415eebb2-c189-45c3-b45f-47548e3442e0
r=s^2+t

# ╔═╡ 7f0ecfc6-0dfd-47b1-992b-8a72fef9fd63
expand(r^4)

# ╔═╡ d91dd3bf-446d-412b-93f5-3596ad3b2825
A = [s^2 + t s 2s
     0       t 2t
     t^2 + s s 0]


# ╔═╡ ec0f4c88-1506-4b1c-8579-767bb656a823
det(A)

# ╔═╡ 3638de9f-366c-4fc5-bd4b-29dd334f7f47
D = Differential(t)

# ╔═╡ e1e70839-e500-4c67-b9d1-7a75f816c241
D(r)

# ╔═╡ 3beda619-01cf-4b77-811e-ccb325e1342e
expand_derivatives(D(r)) 

# ╔═╡ bffa857d-b2f3-41ba-8723-bbed8b0154ba
B = simplify.([t + t^2 + t + t^2  2t + 4t
               s + s+2t     s^2 - 3s^2 + s^2])

# ╔═╡ 956c57a3-513f-41c0-aaa1-7a6c057c489c
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "cf78d892fa66861806b913923fc15d3f6e07a050"
